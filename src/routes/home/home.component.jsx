...
export default function Home() {
  ...
  const onSearchHandler = (event) =>{
    event.target.value.toLocaleLowerCase() === '' ? setSearchField(DEFAULT_SEARCH_VALUE) : 
  ...
  return (
    <div className="App">
      ...
      <input type='text' className="search-box" placeholder="search by name" onChange={onSearchHandler}></input>
